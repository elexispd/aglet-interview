...
The `TMDBService` implements a custom pagination strategy to meet the requirement of serving 45 movies in pages of 9, derived from TMDB's 20-items-per-page API.
...
2.  **Memoization & Caching**:
    ...
    *   **Persistence**: `Cache::remember` stores the merged dataset for 1 hour, minimizing API rate limits.
